...
mat4<numType>::mat4(const mat4<numType>& input) :
	mat4(
		input.xx, input.xy, input.xz, input.xw,
		input.yx, input.yy, input.yz, input.yw,
		input.zx, input.zy, input.zz, input.zw,
		input.wx, input.wy, input.wz, input.ww
	)
{}
...
mat4<numType>::mat4(	numType inXX, numType inXY, numType inXZ, numType inXW,
	...
	xx( m4[0] ), xy( m4[1] ), xz( m4[2] ), xw( m4[3] ),
	yx( m4[4] ), yy( m4[5] ), yz( m4[6] ), yw( m4[7] ),
	zx( m4[8] ), zy( m4[9] ), zz( m4[10] ), zw( m4[11] ),
	wx( m4[12] ), wy( m4[13] ), wz( m4[14] ), ww( m4[15] )
{}
