...
${OBJECTDIR}/src/assert.o: nbproject/Makefile-${CND_CONF}.mk src/assert.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/assert.o src/assert.cpp

${OBJECTDIR}/src/bits.o: nbproject/Makefile-${CND_CONF}.mk src/bits.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bits.o src/bits.cpp

${OBJECTDIR}/src/fixed.o: nbproject/Makefile-${CND_CONF}.mk src/fixed.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fixed.o src/fixed.cpp

${OBJECTDIR}/src/logger.o: nbproject/Makefile-${CND_CONF}.mk src/logger.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/logger.o src/logger.cpp

${OBJECTDIR}/src/mat_utils.o: nbproject/Makefile-${CND_CONF}.mk src/mat_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mat_utils.o src/mat_utils.cpp

${OBJECTDIR}/src/math.o: nbproject/Makefile-${CND_CONF}.mk src/math.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/math.o src/math.cpp

${OBJECTDIR}/src/matrix2.o: nbproject/Makefile-${CND_CONF}.mk src/matrix2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/matrix2.o src/matrix2.cpp

${OBJECTDIR}/src/matrix3.o: nbproject/Makefile-${CND_CONF}.mk src/matrix3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/matrix3.o src/matrix3.cpp

${OBJECTDIR}/src/matrix4.o: nbproject/Makefile-${CND_CONF}.mk src/matrix4.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/matrix4.o src/matrix4.cpp

${OBJECTDIR}/src/pointer.o: nbproject/Makefile-${CND_CONF}.mk src/pointer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pointer.o src/pointer.cpp

${OBJECTDIR}/src/quat.o: nbproject/Makefile-${CND_CONF}.mk src/quat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quat.o src/quat.cpp

${OBJECTDIR}/src/quat_utils.o: nbproject/Makefile-${CND_CONF}.mk src/quat_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quat_utils.o src/quat_utils.cpp

${OBJECTDIR}/src/randomNum.o: nbproject/Makefile-${CND_CONF}.mk src/randomNum.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/randomNum.o src/randomNum.cpp

${OBJECTDIR}/src/scalar_utils.o: nbproject/Makefile-${CND_CONF}.mk src/scalar_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/scalar_utils.o src/scalar_utils.cpp

${OBJECTDIR}/src/timeObject.o: nbproject/Makefile-${CND_CONF}.mk src/timeObject.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/timeObject.o src/timeObject.cpp

${OBJECTDIR}/src/vec2.o: nbproject/Makefile-${CND_CONF}.mk src/vec2.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec2.o src/vec2.cpp

${OBJECTDIR}/src/vec3.o: nbproject/Makefile-${CND_CONF}.mk src/vec3.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec3.o src/vec3.cpp

${OBJECTDIR}/src/vec4.o: nbproject/Makefile-${CND_CONF}.mk src/vec4.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec4.o src/vec4.cpp

${OBJECTDIR}/src/vec_utils.o: nbproject/Makefile-${CND_CONF}.mk src/vec_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec_utils.o src/vec_utils.cpp
...
${TESTDIR}/_ext/2103785198/btree_test.o: ../tests/btree_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -I. -I. -std=c++11 -O2 -lstdthread -lpthread -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/2103785198/btree_test.o ../tests/btree_test.cpp


${TESTDIR}/_ext/2103785198/endian_test.o: ../tests/endian_test.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/2103785198
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/2103785198/endian_test.o ../tests/endian_test.cpp


${TESTDIR}/_ext/2103785198/mathTest.o: ../tests/mathTest.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/2103785198
	${RM} "$@.d"
	$(COMPILE.cc) -s -DGLM_FORCE_PURE -Iinclude -I. -std=c++11 -march=native -mfpmath=sse -msse -msse2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/2103785198/mathTest.o ../tests/mathTest.cpp


${TESTDIR}/_ext/2103785198/pointer_test.o: ../tests/pointer_test.cpp 
	${MKDIR} -p ${TESTDIR}/_ext/2103785198
	${RM} "$@.d"
	$(COMPILE.cc) -s -Iinclude -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/2103785198/pointer_test.o ../tests/pointer_test.cpp
...
${OBJECTDIR}/src/assert_nomain.o: ${OBJECTDIR}/src/assert.o src/assert.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/assert_nomain.o src/assert.cpp;\
	else  \
...
${OBJECTDIR}/src/bits_nomain.o: ${OBJECTDIR}/src/bits.o src/bits.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bits_nomain.o src/bits.cpp;\
	else  \
...
${OBJECTDIR}/src/fixed_nomain.o: ${OBJECTDIR}/src/fixed.o src/fixed.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fixed_nomain.o src/fixed.cpp;\
	else  \
...
${OBJECTDIR}/src/logger_nomain.o: ${OBJECTDIR}/src/logger.o src/logger.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/logger_nomain.o src/logger.cpp;\
	else  \
...
${OBJECTDIR}/src/mat_utils_nomain.o: ${OBJECTDIR}/src/mat_utils.o src/mat_utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mat_utils_nomain.o src/mat_utils.cpp;\
	else  \
...
${OBJECTDIR}/src/math_nomain.o: ${OBJECTDIR}/src/math.o src/math.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/math_nomain.o src/math.cpp;\
	else  \
...
${OBJECTDIR}/src/matrix2_nomain.o: ${OBJECTDIR}/src/matrix2.o src/matrix2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/matrix2_nomain.o src/matrix2.cpp;\
	else  \
...
${OBJECTDIR}/src/matrix3_nomain.o: ${OBJECTDIR}/src/matrix3.o src/matrix3.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/matrix3_nomain.o src/matrix3.cpp;\
	else  \
...
${OBJECTDIR}/src/matrix4_nomain.o: ${OBJECTDIR}/src/matrix4.o src/matrix4.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/matrix4_nomain.o src/matrix4.cpp;\
	else  \
...
${OBJECTDIR}/src/pointer_nomain.o: ${OBJECTDIR}/src/pointer.o src/pointer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pointer_nomain.o src/pointer.cpp;\
	else  \
...
${OBJECTDIR}/src/quat_nomain.o: ${OBJECTDIR}/src/quat.o src/quat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quat_nomain.o src/quat.cpp;\
	else  \
...
${OBJECTDIR}/src/quat_utils_nomain.o: ${OBJECTDIR}/src/quat_utils.o src/quat_utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/quat_utils_nomain.o src/quat_utils.cpp;\
	else  \
...
${OBJECTDIR}/src/randomNum_nomain.o: ${OBJECTDIR}/src/randomNum.o src/randomNum.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/randomNum_nomain.o src/randomNum.cpp;\
	else  \
...
${OBJECTDIR}/src/scalar_utils_nomain.o: ${OBJECTDIR}/src/scalar_utils.o src/scalar_utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/scalar_utils_nomain.o src/scalar_utils.cpp;\
	else  \
...
${OBJECTDIR}/src/timeObject_nomain.o: ${OBJECTDIR}/src/timeObject.o src/timeObject.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/timeObject_nomain.o src/timeObject.cpp;\
	else  \
...
${OBJECTDIR}/src/vec2_nomain.o: ${OBJECTDIR}/src/vec2.o src/vec2.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec2_nomain.o src/vec2.cpp;\
	else  \
...
${OBJECTDIR}/src/vec3_nomain.o: ${OBJECTDIR}/src/vec3.o src/vec3.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec3_nomain.o src/vec3.cpp;\
	else  \
...
${OBJECTDIR}/src/vec4_nomain.o: ${OBJECTDIR}/src/vec4.o src/vec4.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec4_nomain.o src/vec4.cpp;\
	else  \
...
${OBJECTDIR}/src/vec_utils_nomain.o: ${OBJECTDIR}/src/vec_utils.o src/vec_utils.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -s -Iinclude -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/vec_utils_nomain.o src/vec_utils.cpp;\
	else  \
